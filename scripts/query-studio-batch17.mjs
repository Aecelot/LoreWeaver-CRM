// Query batch 17 leads: type=studio, status=new OR status=active
...
async function queryStudioBatch17() {
  console.log('Querying studio leads with status=new OR status=active (offset 0, limit 10)...\n');
...
queryStudioBatch17().then(() => process.exit(0)).catch(err => {
